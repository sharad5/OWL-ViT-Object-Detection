...
dataset_file_name = "data/paco_annotations/paco_ego4d_v1_test_dev_processed.json"
image_root_dir = "data/paco_frames/v1/paco_frames/"
model_checkpoint = "google/owlvit-large-patch14"
img_batch_size = 8
